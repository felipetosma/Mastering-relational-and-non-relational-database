...
SELECT * FROM CLIENTE A
    INNER JOIN TIPO_CLIENTE B ON (A.ID_CLIENTE = B.ID_TIPO_CLIENTE);
    
SELECT * FROM ENDERECO_CLIENTE;


SELECT A.ID_CLIENTE , B.NOM_CLIENTE FROM ENDERECO_CLIENTE A
INNER JOIN CLIENTE B ON (A.ID_CLIENTE = B.ID_CLIENTE);


SELECT A.ID_CLIENTE ID, B.NOM_CLIENTE NOME_CLIENTE
